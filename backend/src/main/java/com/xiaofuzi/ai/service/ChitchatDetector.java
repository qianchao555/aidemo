...
public class ChitchatDetector {
    ...
    private boolean containsBusinessKeyword(String text) {
        ...
        return lower.contains("请假") || lower.contains("报销") || lower.contains("加班")
                ...
                || lower.contains("事假") || lower.contains("丧假") || lower.contains("陪产假")
                || lower.contains("哺乳假") || lower.contains("产检") || lower.contains("哺乳期")
                || lower.contains("孕期") || lower.contains("工伤") || lower.contains("生育")
                || lower.contains("工资") || lower.contains("社保") || lower.contains("公积金")
                || lower.contains("医保") || lower.contains("养老") || lower.contains("失业")
                || lower.contains("试用期") || lower.contains("迟到") || lower.contains("早退")
                || lower.contains("旷工") || lower.contains("流程") || lower.contains("制度") || lower.contains("规定")
